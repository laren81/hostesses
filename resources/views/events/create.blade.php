    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">{{__('texte.events_arr.create.create_event')}}</h3>
                <div class="pull-right">
                    <a class="btn btn-primary back-btn" href="{{route('admin.events.index')}}">{{__('texte.events_arr.show.events')}}</a>
                </div>
            </div>
            <div class="panel-body">
                <form id="event_create" method="POST" action="{{route('admin.events.store')}}" class="form form-horizontal">
                    {{ csrf_field() }}
                    
                    <div class="tabs-container">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class='active'><a class="nav-link active" data-toggle="tab" href="#tab-1">{{__('texte.events_arr.create.general_information')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-2">{{__('texte.events_arr.create.required_staff')}}</a></li>
                        </ul>
                                    ...
                                    <div class='row'>                       
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-6{{ $errors->has('client_id') ? ' has-error' : '' }}">
                                                <label for="client" class="control-label">{{__('texte.events_arr.create.client')}}</label>
                                                <select class="form-control" id="client_id" name="client_id" required>
                                                    <option value="">{{__('texte.events_arr.create.client')}}</option>
                                            ...
                                            <div class="control-group col-xs-12 col-md-6{{ $errors->has('name') ? ' has-error' : '' }}">
                                                <label for="name" class="control-label">{{__('texte.events_arr.create.event_name')}}</label>
                                        ...
                                        <div class="form-group">    
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('internal_location') ? ' has-error' : '' }}">
                                                ...
                                                <div>
                                                    ...
                                                    <label for="radio1">{{__('texte.events_arr.create.yes')}}</label>

                                                    <input type="radio" name="internal_location" value="2" id="radio2" {{old('internal_location')==='2' ? 'checked' : ''}}>
                                                    <label for="radio2">{{__('texte.events_arr.create.no')}}</label>
                                                </div>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('region_id') ? ' has-error' : '' }}">
                                                <label for="region_id" class="control-label">{{__('texte.events_arr.create.region')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                                <label for="city_id" class="control-label">{{__('texte.events_arr.create.zip_city')}}</label>
                                                <div class="ui-widget">                         
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('location') ? ' has-error' : '' }}">
                                                <label for="location" class="control-label">{{__('texte.events_arr.create.event_location')}}</label>
                                        ...
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('date_from') ? ' has-error' : '' }}">
                                                <label for="date_from" class="control-label">{{__('texte.events_arr.create.date_from')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('date_to') ? ' has-error' : '' }}">
                                                <label for="date_to" class="control-label">{{__('texte.events_arr.create.date_to')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('time_from') ? ' has-error' : '' }}">
                                                <label for="time_from" class="control-label">{{__('texte.events_arr.create.time_from')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('time_till') ? ' has-error' : '' }}">
                                                <label for="time_till" class="control-label">{{__('texte.events_arr.create.time_till')}}</label>
                            ...
                            <div role="tabpanel" id="tab-2" class="tab-pane">
                                    ...
                                    <div id="position_1" class='row staff_position'>
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.staff_type') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.staff_type')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.staff_number') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.number')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.staff_gender') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.gender')}}</label>
                                                <select class="form-control staff_gender" name="positions[1][staff_gender]" required>
                                                    <option value=""></option>                                                    
                                                    <option value="1" {{old('positions.1.staff_gender')===1 ? 'selected' : ''}}>{{__('texte.events_arr.create.female')}}</option>
                                                    <option value="2" {{old('positions.1.staff_gender')===2 ? 'selected' : ''}}>{{__('texte.events_arr.create.male')}}</option>
                                                    <option value="0" {{old('positions.1.staff_gender')===0 ? 'selected' : ''}}>{{__('texte.events_arr.create.no_matter')}}</option>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.date_from') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.date_from')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.date_to') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.date_to')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.time_from') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.time_from')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.time_till') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.time_till')}}</label>
                                            ...
                                            <h4 style="margin-left:17px;">{{__('texte.events_arr.create.fill_only')}}</h4>
                                        </div>

                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.height_from') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.height')}} {{__('texte.events_arr.create.from')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.height_to') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.height')}} {{__('texte.events_arr.create.to')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.size_from') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.size')}} {{__('texte.events_arr.create.from')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.size_to') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.size')}} {{__('texte.events_arr.create.to')}}</label>
                                        ...
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-2{{ $errors->has('positions.1.language_1') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.language')}}(1)</label>
                                                <select class="form-control language_1" name="positions[1][language_1]">
                                                    <option value=''></option>
                                                    <option value='de' {{old('positions.1.language_1')=='de' ? 'selected' : ''}}>{{__('texte.events_arr.create.german')}}</option>
                                                    <option value='en' {{old('positions.1.language_1')=='en' ? 'selected' : ''}}>{{__('texte.events_arr.create.english')}}</option>
                                                </select>
                                            ...
                                            <div class="control-group col-xs-12 col-md-2{{ $errors->has('positions.1.language_1_lvl') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.language_level')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-2{{ $errors->has('positions.1.language_2') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.language')}}(2)</label>
                                                <select class="form-control language_2" name="positions[1][language_2]">
                                                    <option value=''></option>
                                                    <option value='de' {{old('positions.1.language_2')=='de' ? 'selected' : ''}}>{{__('texte.events_arr.create.german')}}</option>
                                                    <option value='en' {{old('positions.1.language_2')=='en' ? 'selected' : ''}}>{{__('texte.events_arr.create.english')}}</option>
                                                </select>
                                            ...
                                            <div class="control-group col-xs-12 col-md-2{{ $errors->has('positions.1.language_3') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.language')}}(3)</label>
                                        ...
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.job_description') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.job_description')}}</label>
                                                <textarea class="form-control job_description" name='positions[1][job_description]' placeholder='{{__('texte.events_arr.create.job_description_text')}}' rows='5' required>{{old('positions.1.job_description')}}</textarea>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.outfit') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.outfit')}}</label>
                                                <textarea class="form-control outfit" name='positions[1][outfit]' placeholder='{{__('texte.events_arr.create.outfit_text')}}' rows='5'>{{old('positions.1.outfit')}}</textarea>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.other_comments') ? ' has-error' : '' }}">
                                                <label class="control-label">{{__('texte.events_arr.create.other_comments')}}</label>
                                                <textarea class="form-control other_comments" name='positions[1][other_comments]' placeholder='{{__('texte.events_arr.create.other_comments_text')}}' rows='5'>{{old('positions.1.other_comments')}}</textarea>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12" style='text-align: center;'>
                                        <button type="button" class="btn btn-success add_position">{{__('texte.events_arr.create.add_position')}}</button>   
                                        <button type="button" class="btn btn-danger remove_position">{{__('texte.events_arr.create.remove_position')}}</button>
                                        <button type="submit" class="btn btn-default">{{__('texte.events_arr.create.create')}}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
