    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">{{__('website.clients_arr.create.client_application_form')}}</h3>
            </div>
            
            <div class="panel-body">
                <form id="create_client" method="POST" action="{{route('users.store_client')}}" class="form form-horizontal">
                    {{ csrf_field() }}
                    ...
                    <div class="tabs-container">                     
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li><a class="nav-link" data-toggle="tab" href="#tab-3">Event & Staff details</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-4">Confirmation</a></li>
                        </ul>
                        <div class="tab-content">
                                    ...
                                    <div class='row'>
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('title') ? ' has-error' : '' }}">
                                                <label for="title" class="control-label">{{__('website.clients_arr.create.title')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                                <label for="first_name" class="control-label">{{__('website.clients_arr.create.first_name')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                                <label for="last_name" class="control-label">{{__('website.clients_arr.create.last_name')}}</label>
                                                <input type="text" class="form-control" id="name" name="last_name" value="{{old('last_name')}}" required/>
                                        ...
                                        <div class="form-group">                           
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('email') ? ' has-error' : '' }}">
                                                <label for="email" class="control-label">{{__('website.clients_arr.create.email')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('phone') ? ' has-error' : '' }}">
                                                <label for="phone" class="control-label">{{__('website.clients_arr.create.phone')}}</label>
                            ...
                            <div role="tabpanel" id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <div class='row'>
                                        <div class="form-group">      
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('company_name') ? ' has-error' : '' }}">
                                                <label for="company_name" class="control-label">{{__('website.clients_arr.create.company_name')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('website') ? ' has-error' : '' }}">
                                                <label for="website" class="control-label">{{__('website.clients_arr.create.website')}}</label>
                                        ...
                                        <div class="form-group">                                             
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('region_id') ? ' has-error' : '' }}">
                                                <label class="control-label" for="region">{{__('website.clients_arr.create.region')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                                <label for="city_id" class="control-label">{{__('website.clients_arr.create.zip_city')}}</label>
                                                <div class="ui-widget">                         
                                        ...
                                        <div class="form-group">    
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('street') ? ' has-error' : '' }}">
                                                <label for="street" class="control-label">{{__('website.clients_arr.create.street')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('house_number') ? ' has-error' : '' }}">
                                                <label class="control-label" for="house_number">{{__('website.clients_arr.create.house_number')}}</label>
                            ...
                            <div role="tabpanel" id="tab-3" class="tab-pane">
                                    ...
                                    <div class='row'>                       
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-12{{ $errors->has('name') ? ' has-error' : '' }}">
                                                <label for="name" class="control-label">{{__('website.clients_arr.create.event_name')}}</label>
                                        ...
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('event_region_id') ? ' has-error' : '' }}">
                                                <label for="event_region" class="control-label">{{__('website.clients_arr.create.region')}}</label>
                                                <select class="form-control" id='event_region' name='event_region_id' required>
                                                    <option value=''></option>
                                                    @foreach($regions as $region)
                                                    <option value='{{$region->id}}' {{old('event_region_id')==$region->id ? "selected" : ""}}>{{$region->name}}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('event_region_id'))
                                                    <span class="help-block"><strong>{{ $errors->first('event_region_id') }}</strong></span>
                                                @endif
                                                <div class="errorBox"></div>
                                            </div>
                                            
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('event_city_id') ? ' has-error' : '' }}">
                                                <label for="event_city" class="control-label">{{__('website.clients_arr.create.zip_city')}}</label>
                                                <div class="ui-widget">                         
                                                    <input type="text" class="autocomplete form-control" id="event_city" name="event_city" value="{{old('event_city')}}">
                                                    <input type="hidden" class="form-control" id="event_city_id" name="event_city_id" value="{{old('event_city_id')}}" required/>
                                                </div>                        
                                                @if ($errors->has('event_city_id'))
                                                        <span class="help-block"><strong>{{ $errors->first('event_city_id') }}</strong></span>
                                                @endif
                                                <div class="errorBox"></div>
                                            </div>                                             

                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('location') ? ' has-error' : '' }}">
                                                <label for="location" class="control-label">{{__('website.clients_arr.create.event_location')}}</label>
                                        ...
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('date_from') ? ' has-error' : '' }}">
                                                <label for="date_from" class="control-label">{{__('website.clients_arr.create.date_from')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('date_to') ? ' has-error' : '' }}">
                                                <label for="date_to" class="control-label">{{__('website.clients_arr.create.date_to')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('time_from') ? ' has-error' : '' }}">
                                                <label for="time_from" class="control-label">{{__('website.clients_arr.create.time_from')}}</label>
                                                <input type="text" class="form-control" id="time_from" name="time_from" value="{{old('time_from')}}"/>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('time_till') ? ' has-error' : '' }}">
                                                <label for="time_till" class="control-label">{{__('website.clients_arr.create.time_till')}}</label>
                                                <input type="text" class="form-control" id="time_till" name="time_till" value="{{old('time_till')}}"/>
                                        ...
                                        <div id="position_1" class='row staff_position'>
                                            <div class="form-group">                            
                                                <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.staff_type') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.staff_type')}}</label>
                                                ...
                                                <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.staff_number') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.number')}}</label>
                                                ...
                                                <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.staff_gender') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.gender')}}</label>
                                                    <select class="form-control staff_gender" name="positions[1][staff_gender]" required>
                                                        <option value=""></option>                                                    
                                                        <option value="1" {{old('positions.1.staff_gender')===1 ? 'selected' : ''}}>{{__('website.clients_arr.create.female')}}</option>
                                                        <option value="2" {{old('positions.1.staff_gender')===2 ? 'selected' : ''}}>{{__('website.clients_arr.create.male')}}</option>
                                                        <option value="0" {{old('positions.1.staff_gender')===0 ? 'selected' : ''}}>{{__('website.clients_arr.create.no_matter')}}</option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.date_from') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.date_from')}}</label>
                                                ...
                                                <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.date_to') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.date_to')}}</label>
                                                ...
                                                <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.time_from') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.time_from')}}</label>
                                                ...
                                                <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.time_till') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.time_till')}}</label>
                                                ...
                                                <h4 style="margin-left:17px;">Please fill only if data differs from event dates and times</h4>
                                            </div>

                                            <div class="form-group">                            
                                                <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.height_from') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.height')}} {{__('website.clients_arr.create.from')}}</label>
                                                ...
                                                <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.height_to') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.height')}} {{__('website.clients_arr.create.to')}}</label>
                                                ...
                                                <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.size_from') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.size')}} {{__('website.clients_arr.create.from')}}</label>
                                                ...
                                                <div class="control-group col-xs-12 col-md-3{{ $errors->has('positions.1.size_to') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.size')}} {{__('website.clients_arr.create.to')}}</label>
                                            ...
                                            <div class="form-group">                            
                                                <div class="control-group col-xs-12 col-md-2{{ $errors->has('positions.1.language_1') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.language')}}(1)</label>
                                                    <select class="form-control language_1" name="positions[1][language_1]">
                                                        <option value=''></option>
                                                        <option value='de' {{old('positions.1.language_1')=='de' ? 'selected' : ''}}>{{__('website.clients_arr.create.german')}}</option>
                                                        <option value='en' {{old('positions.1.language_1')=='en' ? 'selected' : ''}}>{{__('website.clients_arr.create.english')}}</option>
                                                    </select>
                                                ...
                                                <div class="control-group col-xs-12 col-md-2{{ $errors->has('positions.1.language_1_lvl') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.language_level')}}</label>
                                                ...
                                                <div class="control-group col-xs-12 col-md-2{{ $errors->has('positions.1.language_2') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.language')}}(2)</label>
                                                    <select class="form-control language_2" name="positions[1][language_2]">
                                                        <option value=''></option>
                                                        <option value='de' {{old('positions.1.language_2')=='de' ? 'selected' : ''}}>{{__('website.clients_arr.create.german')}}</option>
                                                        <option value='en' {{old('positions.1.language_2')=='en' ? 'selected' : ''}}>{{__('website.clients_arr.create.english')}}</option>
                                                    </select>
                                                ...
                                                <div class="control-group col-xs-12 col-md-2{{ $errors->has('positions.1.language_3') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.language')}}(3)</label>
                                            ...
                                            <div class="form-group">                            
                                                <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.job_description') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.job_description')}}</label>
                                                    <textarea class="form-control job_description" name='positions[1][job_description]' placeholder='{{__('website.clients_arr.create.job_description_text')}}' rows='5' required>{{old('positions.1.job_description')}}</textarea>
                                                ...
                                                <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.outfit') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.outfit')}}</label>
                                                    <textarea class="form-control outfit" name='positions[1][outfit]' placeholder='{{__('website.clients_arr.create.outfit_text')}}' rows='5'>{{old('positions.1.outfit')}}</textarea>
                                                ...
                                                <div class="control-group col-xs-12 col-md-4{{ $errors->has('positions.1.other_comments') ? ' has-error' : '' }}">
                                                    <label class="control-label">{{__('website.clients_arr.create.other_comments')}}</label>
                                                    <textarea class="form-control other_comments" name='positions[1][other_comments]' placeholder='{{__('website.clients_arr.create.other_comments_text')}}' rows='5'>{{old('positions.1.other_comments')}}</textarea>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12" style='text-align: center;'>
                                        <button type="button" class="btn btn-success add_position">{{__('website.clients_arr.create.add_position')}}</button>
                                        <button type="button" class="btn btn-danger remove_position">{{__('website.clients_arr.create.remove_position')}}</button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class='row'>
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-9{{ $errors->has('terms_agreed') ? ' has-error' : '' }}">
                                                <div>
                                                    ...
                                                    <strong>{{__('website.clients_arr.create.accept')}}</strong> {{__('website.clients_arr.create.our')}} <a href="/nutzungsbedingungen/hostessen.html" target="_blank" class="alert-link">{{__('website.clients_arr.create.terms_of_use')}}</a> &amp; <a href="/datenschutz/" target="_blank" class="alert-link">{{__('website.clients_arr.create.data_protection')}}</a>.
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-6" style='text-align: center;'>
                                                <button type="submit" class="btn btn-default">{{__('website.clients_arr.create.submit')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript" charset="utf-8">
    $('#title,#region,#event_region').select2();
    $('.staff_type,.staff_gender,.height_from,.height_to,.size_from,.size_to,.language_1,.language_1_lvl,.language_2,.language_2_lvl,.language_3,.language_3_lvl').select2();
    ...
    $(document).on('focus', '.autocomplete', function () {
        ...
        if(id==='city'){
            ...
            var region_id = $('#event_region').val();
        }
        ...
        element.autocomplete({
            ...
            select:function(e,ui)
            {
                ...
                if(id==='city'){
                    ...
                    $('#event_region').val(ui.item.region_id).trigger('change');
                    $('#event_city_id').val(ui.item.id); 
                }
