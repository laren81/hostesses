    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">{{__('website.clients_arr.edit.edit_client')}}</h3>
            </div>

            <div class="panel-body">
                <form id="edit_client" method="POST" action="{{route('clients.update',$client->id)}}" class="form form-horizontal">
                    {{ method_field('PATCH') }}
                    {{ csrf_field() }}
                                    ...
                                    <div class='row'>
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('title') ? ' has-error' : '' }}">
                                                <label for="title" class="control-label">{{__('website.clients_arr.edit.title')}}</label>
                                                <select class="form-control" id="title" name="title" required>
                                                    <option value="">{{__('website.clients_arr.edit.select')}}</option>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                                <label for="first_name" class="control-label">{{__('website.clients_arr.edit.first_name')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                                <label for="last_name" class="control-label">{{__('website.clients_arr.edit.last_name')}}</label>
                                        ...
                                        <div class="form-group">                           
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('email') ? ' has-error' : '' }}">
                                                <label for="email" class="control-label">{{__('website.clients_arr.edit.email')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('phone') ? ' has-error' : '' }}">
                                                <label for="phone" class="control-label">{{__('website.clients_arr.edit.phone')}}</label>
                                        ...
                                        <div class="form-group">                                                
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                                <label class="control-label" for="password">{{__('website.clients_arr.edit.password')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                                <label class="control-label" for="password-confirm">{{__('website.clients_arr.edit.confirm_password')}}</label>                                                
                                    ...
                                    <div class='row'> 
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('company_name') ? ' has-error' : '' }}">
                                                <label for="company_name" class="control-label">{{__('website.clients_arr.edit.company_name')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('website') ? ' has-error' : '' }}">
                                                <label for="website" class="control-label">{{__('website.clients_arr.edit.website')}}</label>
                                        ...
                                        <div class="form-group">                                            
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('region_id') ? ' has-error' : '' }}">
                                                <label class="control-label" for="region">{{__('website.clients_arr.edit.region')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                                <label for="city_id" class="control-label">{{__('website.clients_arr.edit.city')}}</label>
                                                <div class="ui-widget">                         
                                        ...
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('street') ? ' has-error' : '' }}">
                                                <label for="street" class="control-label">{{__('website.clients_arr.edit.street')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('house_number') ? ' has-error' : '' }}">
                                                <label class="control-label" for="house_number">{{__('website.clients_arr.edit.house_number')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12" style='text-align: center;'>
                                                <button type="submit" class="btn btn-default">{{__('website.clients_arr.edit.submit')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
