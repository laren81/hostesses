    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">{{__('website.hostesses_arr.create_profile.hostess_profile')}}</h3>
            </div>
            
            <div class="panel-body">
                <form id="create_hostess_profile" method="POST" action="{{route('users.store_hostess_profile',auth()->user()->id)}}" class="form form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    <div class="tabs-container">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class='active'><a class="nav-link active" data-toggle="tab" href="#tab-1">{{__('website.hostesses_arr.create_profile.personal_information')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-2">{{__('website.hostesses_arr.create_profile.profile')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-3">{{__('website.hostesses_arr.create_profile.experience')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-4">{{__('website.hostesses_arr.create_profile.images')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-5">{{__('website.hostesses_arr.create_profile.confirmation')}}</a></li>
                        </ul>
                        <div class="tab-content">
                            <div role="tabpanel" id="tab-1" class="tab-pane active">                                
                                <div class="panel-body">
                                    <div class='row'>
                                        ...
                                        <h3>{{__('website.hostesses_arr.create_profile.preferred_areas')}}</h3>  
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('sex') ? ' has-error' : '' }}">
                                                <label for="title" class="control-label">{{__('website.hostesses_arr.create_profile.sex')}}</label>
                                                <div>
                                                    <input type="radio" name="sex" value="1" id="radio1" {{old('sex')==='1' ? 'checked' : ''}}>
                                                    <label for="radio1">{{__('website.hostesses_arr.create_profile.female')}}</label>

                                                    <input type="radio" name="sex" value="2" id="radio2" {{old('sex')==='2' ? 'checked' : ''}}>
                                                    <label for="radio2">{{__('website.hostesses_arr.create_profile.male')}}</label>
                                                </div>
                                                @if ($errors->has('sex'))
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('birth_date') ? ' has-error' : '' }}">
                                                <label class="control-label" for="birth_date">{{__('website.hostesses_arr.create_profile.birth_date')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('country') ? ' has-error' : '' }}">
                                                <label class="control-label" for="country">{{__('website.hostesses_arr.create_profile.country')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('nationality') ? ' has-error' : '' }}">
                                                <label class="control-label" for="nationality"> {{__('website.hostesses_arr.create_profile.nationality')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('region_id') ? ' has-error' : '' }}">
                                                <label class="control-label" for="region_id">{{__('website.hostesses_arr.create_profile.region')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                                <label for="city_id" class="control-label">{{__('website.hostesses_arr.create_profile.zip_city')}}</label>
                                                <div class="ui-widget">                         
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('address') ? ' has-error' : '' }}">
                                                <label class="control-label" for="address">{{__('website.hostesses_arr.create_profile.address')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('type') ? ' has-error' : '' }}">
                                                <label class="control-label" for="type">{{__('website.hostesses_arr.create_profile.type')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('height') ? ' has-error' : '' }}">
                                                <label class="control-label" for="height">{{__('website.hostesses_arr.create_profile.height')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('cloth_size') ? ' has-error' : '' }}">
                                                <label class="control-label" for="cloth_size">{{__('website.hostesses_arr.create_profile.cloth_size')}}</label>
                                        ...
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('chest') ? ' has-error' : '' }}">
                                                <label class="control-label" for="chest">{{__('website.hostesses_arr.create_profile.chest')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('waist') ? ' has-error' : '' }}">
                                                <label class="control-label" for="waist">{{__('website.hostesses_arr.create_profile.waist')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('hips') ? ' has-error' : '' }}">
                                                <label class="control-label" for="hips">{{__('website.hostesses_arr.create_profile.hips')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('hair_color') ? ' has-error' : '' }}">
                                                <label class="control-label" for="hair_color">{{__('website.hostesses_arr.create_profile.hair_color')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('eye_color') ? ' has-error' : '' }}">
                                                <label class="control-label" for="eye_color">{{__('website.hostesses_arr.create_profile.eye_color')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('shoe_size') ? ' has-error' : '' }}">
                                                <label class="control-label" for="shoe_size">{{__('website.hostesses_arr.create_profile.shoe_size')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('tattoo') ? ' has-error' : '' }}">      
                                                <label class="control-label text-left" for="tattoo">{{__('website.hostesses_arr.create_profile.visible_tattoo')}}</label>
                                                <div>                                    
                                                    <input type="radio" name="tattoo" value="1" id="radio3" {{old('tattoo')==='1' ? 'checked' : ''}}>
                                                    <label for="radio3">{{__('website.hostesses_arr.create_profile.yes')}}</label>

                                                    <input type="radio" name="tattoo" value="0" id="radio4" {{old('tattoo')==='0' ? 'checked' : ''}}>
                                                    <label for="radio4">{{__('website.hostesses_arr.create_profile.no')}}</label> 
                                                </div>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('piercing') ? ' has-error' : '' }}">      
                                                <label class="control-label" for="piercing">{{__('website.hostesses_arr.create_profile.visible_piercing')}}</label>                                
                                                <div>
                                                    <input type="radio" name="piercing" value="1" id="radio5" {{old('piercing')==='1' ? 'checked' : ''}}>
                                                    <label for="radio5">{{__('website.hostesses_arr.create_profile.yes')}}</label>

                                                    <input type="radio" name="piercing" value="0" id="radio6" {{old('piercing')==='0' ? 'checked' : ''}}>
                                                    <label for="radio6">{{__('website.hostesses_arr.create_profile.no')}}</label>
                                                </div>    
                            ...
                            <div role="tabpanel" id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <div class='row'>
                                        <h3>{{__('website.hostesses_arr.create_profile.profile')}}</h3>

                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('occupation') ? ' has-error' : '' }}">
                                                <label class="control-label" for="occupation">{{__('website.hostesses_arr.create_profile.occupation')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('profession') ? ' has-error' : '' }}">
                                                <label class="control-label" for="profession">{{__('website.hostesses_arr.create_profile.profession')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('education') ? ' has-error' : '' }}">                                
                                                <label class="control-label" for="education">{{__('website.hostesses_arr.create_profile.education')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('driver_licence') ? ' has-error' : '' }}">      
                                                <label class="control-label text-left" for="driver_licence">{{__('website.hostesses_arr.create_profile.driver_licence')}}</label>
                                                <div>                                    
                                                    <input type="radio" name="driver_licence" value="1" id="radio7" {{old('driver_licence')==='1' ? 'checked' : ''}}>
                                                    <label for="radio7">{{__('website.hostesses_arr.create_profile.yes')}}</label>

                                                    <input type="radio" name="driver_licence" value="0" id="radio8" {{old('driver_licence')==='0' ? 'checked' : ''}}>
                                                    <label for="radio8">{{__('website.hostesses_arr.create_profile.no')}}</label>                                    
                                                </div>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('own_car') ? ' has-error' : '' }}">      
                                                <label class="control-label" for="own_car">{{__('website.hostesses_arr.create_profile.own_car')}}</label>
                                                <div>                                    
                                                    <input type="radio" name="own_car" value="1" id="radio9" {{old('own_car')==='1' ? 'checked' : ''}}>
                                                    <label for="radio9">{{__('website.hostesses_arr.create_profile.yes')}}</label>

                                                    <input type="radio" name="own_car" value="0" id="radio10" {{old('old_car')==='0' ? 'checked' : ''}}>
                                                    <label for="radio10">{{__('website.hostesses_arr.create_profile.no')}}</label>                                    
                                                </div>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('trade_licence') ? ' has-error' : '' }}">      
                                                <label class="control-label" for="trade_licence">{{__('website.hostesses_arr.create_profile.trade_licence')}}</label>
                                                <div>
                                                    <input type="radio" name="trade_licence" value="1" id="radio11" {{old('trade_licence')==='1' ? 'checked' : ''}}>
                                                    <label for="radio11">{{__('website.hostesses_arr.create_profile.yes')}}</label>

                                                    <input type="radio" name="trade_licence" value="0" id="radio12" {{old('trade_licence')==='0' ? 'checked' : ''}}>
                                                    <label for="radio12">{{__('website.hostesses_arr.create_profile.no')}}</label>                                    
                                                </div> 
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('health_certificate') ? ' has-error' : '' }}">     
                                                <label class="control-label" for="health_certificate">{{__('website.hostesses_arr.create_profile.health_certificate')}}</label>
                                                <div>                                    
                                                    <input type="radio" name="health_certificate" value="1" id="radio13" {{old('health_certificate')==='1' ? 'checked' : ''}}>
                                                    <label for="radio13">{{__('website.hostesses_arr.create_profile.yes')}}</label>

                                                    <input type="radio" name="health_certificate" value="0" id="radio14" {{old('health_certificate')==='0' ? 'checked' : ''}}>
                                                    <label for="radio14">{{__('website.hostesses_arr.create_profile.no')}}</label>                                    
                                                </div>
                                        ...
                                        <br/>
                                        <h3>{{__('website.hostesses_arr.create_profile.spoken_languages')}}</h3>

                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('de') ? ' has-error' : '' }}">
                                                <label class="control-label" for="de">{{__('website.hostesses_arr.create_profile.german')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('en') ? ' has-error' : '' }}">
                                                <label class="control-label" for="en">{{__('website.hostesses_arr.create_profile.english')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('sp') ? ' has-error' : '' }}">
                                                <label class="control-label" for="sp">{{__('website.hostesses_arr.create_profile.spanish')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('fr') ? ' has-error' : '' }}">
                                                <label class="control-label" for="fr">{{__('website.hostesses_arr.create_profile.french')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_1') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_1">{{__('website.hostesses_arr.create_profile.other_language')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_1_lvl') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_1_lvl"> {{__('website.hostesses_arr.create_profile.level')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_2') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_2">{{__('website.hostesses_arr.create_profile.other_language')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_2_lvl') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_2_lvl"> {{__('website.hostesses_arr.create_profile.level')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_3') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_3">{{__('website.hostesses_arr.create_profile.other_language')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_3_lvl') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_3_lvl"> {{__('website.hostesses_arr.create_profile.level')}}</label>
                                        ...
                                        <br/>
                                        <h3>{{__('website.hostesses_arr.create_profile.accommodation_places')}}</h3>                       
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-12{{ $errors->has('accommodation_places') ? ' has-error' : '' }}">
                                                @foreach($main_cities as $main_city)
                                                <label class="city_name" style='margin-right:2%;min-width:135px;'> 
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('other_cities') ? ' has-error' : '' }}">
                                               <label class="control-label" for="other_cities">{{__('website.hostesses_arr.create_profile.other_cities')}}</label>
                                    ...
                                    <div class='row'>
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('modeling') ? ' has-error' : '' }}">
                                                <label class="control-label" for="modeling">{{__('website.hostesses_arr.create_profile.modeling')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('presentation') ? ' has-error' : '' }}">
                                                <label class="control-label" for="presentation">{{__('website.hostesses_arr.create_profile.presentation')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('gastronomy') ? ' has-error' : '' }}">                                
                                                <label class="control-label" for="gastronomy">{{__('website.hostesses_arr.create_profile.gastronomy')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('team_leader') ? ' has-error' : '' }}">
                                                <label class="control-label" for="team_leader">{{__('website.hostesses_arr.create_profile.team_leader')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('experience_abroad') ? ' has-error' : '' }}">
                                                <label class="control-label" for="experience_abroad">{{__('website.hostesses_arr.create_profile.experience_abroad')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('musical_instrument') ? ' has-error' : '' }}">
                                                <label class="control-label" for="musical_instrument">{{__('website.hostesses_arr.create_profile.musical_instrument')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-12{{ $errors->has('past_experience') ? ' has-error' : '' }}">
                                                <label class="control-label" for="past_experience">{{__('website.hostesses_arr.create_profile.past_experience')}}</label>
                                    ...
                                    <div class='row'>
                                        <div class="form-group">
                                            <div class="col-xs-12 text-left">
                                                <br><br>
                                                <b ><h3><font size="2" color="ff5a5f">*</font> {{__('website.hostesses_arr.create_profile.upload_pictures')}}</h3></b>
                                                <br>
                                                <p>{!!__('website.hostesses_arr.create_profile.upload_pictures_text_1')!!}</p> 
                                                <img src="{{asset('images/website/Portrait.jpg')}}" alt="{{__('website.hostesses_arr.create_profile.hostesses_home')}}" title="{{__('website.hostesses_arr.create_profile.hostesses_home')}}" width="195" height="283" border="1">
                                                <img src="{{asset('images/website/Ganzkoerperbild.jpg')}}" alt="{{__('website.hostesses_arr.create_profile.hostesses_home')}}" title="{{__('website.hostesses_arr.create_profile.hostesses_home')}}e" width="195" height="283" border="1">
                                                <img src="{{asset('images/website/amerikanisches-Portrait.jpg')}}" alt="{{__('website.hostesses_arr.create_profile.hostesses_home')}}" title="{{__('website.hostesses_arr.create_profile.hostesses_home')}}" width="195" height="283" border="1">
                                                <br>
                                                {!!__('website.hostesses_arr.create_profile.upload_pictures_text_2')!!}
                                                ...
                                                <div class="add_element_image">
                                                    <a href="javascript:;" class="btn btn-primary btn-default add_image">{{__('website.hostesses_arr.create_profile.add_image')}}</a>
                                                </div>
                                            </div>
                                        </div> 
                                    </div>
                            ...
                            <div role="tabpanel" id="tab-5" class="tab-pane">
                                <div class="panel-body">
                                    <div class='row'>
                                        <b ><h3><font size="2" color="ff5a5f">*</font>  {{__('website.hostesses_arr.create_profile.public_model_file')}}</h3></b>
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-9{{ $errors->has('public_consent') ? ' has-error' : '' }}">
                                                <p>{!!__('website.hostesses_arr.create_profile.text3')!!}</p>
                                                <div>                                        
                                                    <input type="radio" name="public_consent" value="1" class="styled">
                                                    <label for="public_consent">{{__('website.hostesses_arr.create_profile.public_yes')}}</label>
                                                </div>
                                                <div>    
                                                    <input type="radio" name="public_consent" value="0" class="styled">
                                                    <label for="public_consent">{{__('website.hostesses_arr.create_profile.public_no')}}</label>                                        
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-9{{ $errors->has('terms_agreed') ? ' has-error' : '' }}">
                                                <div>
                                                    ...
                                                    <strong>{{__('website.hostesses_arr.create_profile.accept')}}</strong> {{__('website.hostesses_arr.create_profile.our')}} <a href="/nutzungsbedingungen/hostessen.html" target="_blank" class="alert-link">{{__('website.hostesses_arr.create_profile.terms_of_use')}}</a> &amp; <a href="/datenschutz/" target="_blank" class="alert-link">{{__('website.hostesses_arr.create_profile.data_protection')}}</a>.
                                                </div>
                                        ...
                                        <button type="submit">{{__('website.hostesses_arr.create_profile.submit_formular')}}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
