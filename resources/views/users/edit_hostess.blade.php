    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">{{__('texte.users_arr.edit_hostess.edit_hostess')}} {{$user->first_name}} {{$user->last_name}}</h3>
            </div>
            
            <div class="panel-body">
                <form id="edit_hostess" method="POST" action="{{ route('admin.hostesses.update',$hostess->id) }}" class="form form-horizontal" enctype="multipart/form-data">
                    {{ method_field('PATCH') }}
                    {{ csrf_field() }}
                    ...
                    <div class="tabs-container">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class='active'><a class="nav-link active" data-toggle="tab" href="#tab-1">{{__('texte.users_arr.edit_hostess.contacts')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-2">{{__('texte.users_arr.edit_hostess.personal_information')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-3">{{__('texte.users_arr.edit_hostess.profile')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-4">{{__('texte.users_arr.edit_hostess.experience')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-5">{{__('texte.users_arr.edit_hostess.images')}}</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-6">{{__('texte.users_arr.edit_hostess.confirmation')}}</a></li>
                        </ul>
                        <div class="tab-content">
                                    ...
                                    <div class='row'>                                        
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                                <label class="control-label" for="first_name">{{__('texte.users_arr.edit_hostess.first_name')}}</label>
                                                <input type="text" class="form-control" name="first_name" placeholder="{{__('texte.users_arr.edit_hostess.first_name')}}" value="{{old('first_name',$user->first_name)}}" required>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                                <label class="control-label" for="last_name"> {{__('texte.users_arr.edit_hostess.last_name')}}</label>
                                                <input type="text" class="form-control" name="last_name" placeholder="{{__('texte.users_arr.edit_hostess.last_name')}}" value="{{old('last_name',$user->last_name)}}">
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('email') ? ' has-error' : '' }}">
                                                <label class="control-label" for="email">{{__('texte.users_arr.edit_hostess.email')}}</label>
                                                <input type="text" class="form-control" name="email" placeholder="{{__('texte.users_arr.edit_hostess.email')}}" value="{{old('email',$user->email)}}">
                                                @if ($errors->has('email'))
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('phone') ? ' has-error' : '' }}">
                                                <label class="control-label" for="phone">{{__('texte.users_arr.edit_hostess.mobile')}}</label>
                                                <input type="text" class="form-control" name="phone" placeholder="{{__('texte.users_arr.edit_hostess.mobile_example')}}" value="{{old('phone',$user->phone)}}">
                                                @if ($errors->has('phone'))
                                        ...
                                        <div class="form-group col-xs-12 col-md-3 {{ $errors->has('active') ? ' has-error' : '' }}">                                            
                                            <label for="active" class="control-label">
                                                <input type="checkbox" id="active" name="active" value="1" {{ $user->active==1 ? "checked" : ""}} /> {{__('texte.users_arr.edit_hostess.active')}} 
                                            </label>
                            ...
                            <div role="tabpanel" id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <div class='row'>
                                        ...
                                        <h3>{{__('texte.users_arr.edit_hostess.preferred_areas')}}</h3>  
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('sex') ? ' has-error' : '' }}">
                                                <label for="title" class="control-label">{{__('texte.users_arr.edit_hostess.sex')}}</label>
                                                <div>
                                                    <input type="radio" name="sex" value="1" id="radio1" {{old('sex',$hostess->sex)==1 ? 'checked' : ''}}>
                                                    <label for="radio1">{{__('texte.users_arr.edit_hostess.female')}}</label>

                                                    <input type="radio" name="sex" value="2" id="radio2" {{old('sex',$hostess->sex)==2 ? 'checked' : ''}}>
                                                    <label for="radio2">{{__('texte.users_arr.edit_hostess.male')}}</label>
                                                </div>
                                                @if ($errors->has('sex'))
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('birth_date') ? ' has-error' : '' }}">
                                                <label class="control-label" for="birth_date">{{__('texte.users_arr.edit_hostess.birth_date')}}</label>
                                                <input type="text" class="form-control" id="birth_date" name="birth_date" placeholder="{{__('texte.users_arr.edit_hostess.birth_date')}}" value="{{old('birth_date',date('d.m.Y',strtotime($hostess->birth_date)))}}"/> 
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('country') ? ' has-error' : '' }}">
                                                <label class="control-label" for="country">{{__('texte.users_arr.edit_hostess.country')}}</label>
                                                <input type="text" class="form-control" name="country" placeholder="{{__('texte.users_arr.edit_hostess.country_example')}}" value="{{old('country',$hostess->country)}}">
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('nationality') ? ' has-error' : '' }}">
                                                <label class="control-label" for="nationality"> {{__('texte.users_arr.edit_hostess.nationality')}}</label>
                                                <input type="text" class="form-control" name="nationality" placeholder="{{__('texte.users_arr.edit_hostess.nationality_example')}}" value="{{old('nationality',$hostess->nationality)}}">
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('region_id') ? ' has-error' : '' }}">
                                                <label class="control-label" for="region_id">{{__('texte.users_arr.edit_hostess.region')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                                <label for="city_id" class="control-label">{{__('texte.users_arr.edit_hostess.zip_city')}}</label>
                                                <div class="ui-widget">                         
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('address') ? ' has-error' : '' }}">
                                                <label for="address" class="control-label">{{__('texte.users_arr.edit_hostess.address')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('type') ? ' has-error' : '' }}">
                                                <label class="control-label" for="type">{{__('texte.users_arr.edit_hostess.type')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('height') ? ' has-error' : '' }}">
                                                <label class="control-label" for="height">{{__('texte.users_arr.edit_hostess.height')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('cloth_size') ? ' has-error' : '' }}">
                                                <label class="control-label" for="cloth_size">{{__('texte.users_arr.edit_hostess.cloth_size')}}</label>
                                        ...
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('chest') ? ' has-error' : '' }}">
                                                <label class="control-label" for="chest">{{__('texte.users_arr.edit_hostess.chest')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('waist') ? ' has-error' : '' }}">
                                                <label class="control-label" for="waist">{{__('texte.users_arr.edit_hostess.waist')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('hips') ? ' has-error' : '' }}">
                                                <label class="control-label" for="hips">{{__('texte.users_arr.edit_hostess.hips')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('hair_color') ? ' has-error' : '' }}">
                                                <label class="control-label" for="hair_color">{{__('texte.users_arr.edit_hostess.hair_color')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('eye_color') ? ' has-error' : '' }}">
                                                <label class="control-label" for="eye_color">{{__('texte.users_arr.edit_hostess.eye_color')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('shoe_size') ? ' has-error' : '' }}">
                                                <label class="control-label" for="shoe_size">{{__('texte.users_arr.edit_hostess.shoe_size')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('tattoo') ? ' has-error' : '' }}">      
                                                <label class="control-label text-left" for="tattoo">{{__('texte.users_arr.edit_hostess.visible_tattoo')}}</label>
                                                <div>                                    
                                                    <input type="radio" name="tattoo" value="1" id="radio3" {{old('tattoo',$hostess->tattoo)==1 ? 'checked' : ''}}>
                                                    <label for="radio3">{{__('texte.users_arr.edit_hostess.yes')}}</label>

                                                    <input type="radio" name="tattoo" value="0" id="radio4" {{old('tattoo',$hostess->tattoo)==0 ? 'checked' : ''}}>
                                                    <label for="radio4">{{__('texte.users_arr.edit_hostess.no')}}</label> 
                                                </div>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('piercing') ? ' has-error' : '' }}">      
                                                <label class="control-label" for="piercing">{{__('texte.users_arr.edit_hostess.visible_piercing')}}</label>                                
                                                <div>
                                                    <input type="radio" name="piercing" value="1" id="radio5" {{old('piercing',$hostess->piercing)==1 ? 'checked' : ''}}>
                                                    <label for="radio5">{{__('texte.users_arr.edit_hostess.yes')}}</label>

                                                    <input type="radio" name="piercing" value="0" id="radio6" {{old('piercing',$hostess->piercing)==0 ? 'checked' : ''}}>
                                                    <label for="radio6">{{__('texte.users_arr.edit_hostess.no')}}</label>
                                                </div>    
                            ...
                            <div role="tabpanel" id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                    <div class='row'>
                                        <h3>{{__('texte.users_arr.edit_hostess.profile')}}</h3>

                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('occupation') ? ' has-error' : '' }}">
                                                <label class="control-label" for="occupation">{{__('texte.users_arr.edit_hostess.occupation')}}</label>
                                                <input type="text" class="form-control" name="occupation" placeholder="{{__('texte.users_arr.edit_hostess.occupation_example')}}" value="{{old('occupation',$hostess->occupation)}}">
                                                @if ($errors->has('tattoo'))
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('profession') ? ' has-error' : '' }}">
                                                <label class="control-label" for="profession">{{__('texte.users_arr.edit_hostess.profession')}}</label>
                                                <input type="text" class="form-control" name="profession" placeholder="{{__('texte.users_arr.edit_hostess.profession_example')}}" value="{{old('profession',$hostess->occupation)}}">
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('education') ? ' has-error' : '' }}">                                
                                                <label class="control-label" for="education">{{__('texte.users_arr.edit_hostess.education')}}</label>
                                                <input type="text" class="form-control" name="education" placeholder="{{__('texte.users_arr.edit_hostess.education_example')}}" value="{{old('education',$hostess->education)}}">
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('driver_licence') ? ' has-error' : '' }}">      
                                                <label class="control-label text-left" for="driver_licence">{{__('texte.users_arr.edit_hostess.driver_licence')}}</label>
                                                <div>                                    
                                                    <input type="radio" name="driver_licence" value="1" id="radio7" {{old('driver_licence',$hostess->driver_licence)==1 ? 'checked' : ''}}>
                                                    <label for="radio7">{{__('texte.users_arr.edit_hostess.yes')}}</label>

                                                    <input type="radio" name="driver_licence" value="0" id="radio8" {{old('driver_licence',$hostess->driver_licence)==0 ? 'checked' : ''}}>
                                                    <label for="radio8">{{__('texte.users_arr.edit_hostess.no')}}</label>                                    
                                                </div>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('own_car') ? ' has-error' : '' }}">      
                                                <label class="control-label" for="own_car">{{__('texte.users_arr.edit_hostess.own_car')}}</label>
                                                <div>                                    
                                                    <input type="radio" name="own_car" value="1" id="radio9" {{old('own_car',$hostess->own_car)==1 ? 'checked' : ''}}>
                                                    <label for="radio9">{{__('texte.users_arr.edit_hostess.yes')}}</label>

                                                    <input type="radio" name="own_car" value="0" id="radio10" {{old('old_car',$hostess->own_car)==0 ? 'checked' : ''}}>
                                                    <label for="radio10">{{__('texte.users_arr.edit_hostess.no')}}</label>                                    
                                                </div>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('trade_licence') ? ' has-error' : '' }}">      
                                                <label class="control-label" for="trade_licence">{{__('texte.users_arr.edit_hostess.trade_licence')}}</label>
                                                <div>
                                                    <input type="radio" name="trade_licence" value="1" id="radio11" {{old('trade_licence',$hostess->trade_licence)==1 ? 'checked' : ''}}>
                                                    <label for="radio11">{{__('texte.users_arr.edit_hostess.yes')}}</label>

                                                    <input type="radio" name="trade_licence" value="0" id="radio12" {{old('trade_licence',$hostess->trade_licence)==0 ? 'checked' : ''}}>
                                                    <label for="radio12">{{__('texte.users_arr.edit_hostess.no')}}</label>                                    
                                                </div> 
                                        ...
                                        <br/>
                                        <h3>{{__('texte.users_arr.edit_hostess.spoken_languages')}}</h3>

                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('de') ? ' has-error' : '' }}">
                                                <label class="control-label" for="de">{{__('texte.users_arr.edit_hostess.german')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('en') ? ' has-error' : '' }}">
                                                <label class="control-label" for="en">{{__('texte.users_arr.edit_hostess.english')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('sp') ? ' has-error' : '' }}">
                                                <label class="control-label" for="sp">{{__('texte.users_arr.edit_hostess.spanish')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('fr') ? ' has-error' : '' }}">
                                                <label class="control-label" for="fr">{{__('texte.users_arr.edit_hostess.french')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_1') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_1">{{__('texte.users_arr.edit_hostess.other_language')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_1_lvl') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_1_lvl"> {{__('texte.users_arr.edit_hostess.level')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_2') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_2">{{__('texte.users_arr.edit_hostess.other_language')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_2_lvl') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_2_lvl"> {{__('texte.users_arr.edit_hostess.level')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_3') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_3">{{__('texte.users_arr.edit_hostess.other_language')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-3{{ $errors->has('other_language_3_lvl') ? ' has-error' : '' }}">
                                                <label class="control-label" for="other_language_3_lvl"> {{__('texte.users_arr.edit_hostess.level')}}</label>
                                        ...
                                        <br/>
                                        <h3>{{__('texte.users_arr.edit_hostess.accommodation_places')}}</h3>                       
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('other_cities') ? ' has-error' : '' }}">
                                               <label class="control-label" for="other_cities">{{__('texte.users_arr.edit_hostess.other_cities')}}</label>
                                               <input type="text" class="form-control" name="other_cities" placeholder="{{__('texte.users_arr.edit_hostess.other_cities_example')}}" value='{{old('other_cities',$hostess->other_cities)}}'>
                                            </div>
                                    ...
                                    <div class='row'>
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('modeling') ? ' has-error' : '' }}">
                                                <label class="control-label" for="modeling">{{__('texte.users_arr.edit_hostess.modeling')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('presentation') ? ' has-error' : '' }}">
                                                <label class="control-label" for="presentation">{{__('texte.users_arr.edit_hostess.presentation')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('gastronomy') ? ' has-error' : '' }}">                                
                                                <label class="control-label" for="gastronomy">{{__('texte.users_arr.edit_hostess.gastronomy')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('team_leader') ? ' has-error' : '' }}">
                                                <label class="control-label" for="team_leader">{{__('texte.users_arr.edit_hostess.team_leader')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('experience_abroad') ? ' has-error' : '' }}">
                                                <label class="control-label" for="experience_abroad">{{__('texte.users_arr.edit_hostess.experience_abroad')}}</label>
                                            ...
                                            <div class="control-group col-xs-12 col-md-4{{ $errors->has('musical_instrument') ? ' has-error' : '' }}">
                                                <label class="control-label" for="musical_instrument">{{__('texte.users_arr.edit_hostess.musical_instrument')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group col-xs-12 col-md-12{{ $errors->has('past_experience') ? ' has-error' : '' }}">
                                                <label class="control-label" for="past_experience">{{__('texte.users_arr.edit_hostess.past_experience')}}</label>
                                                <textarea class="form-control" type="text" name="past_experience" rows="6" placeholder="{{__('texte.users_arr.edit_hostess.past_experience_example')}}">{{old('past_experience',$hostess->past_experience)}}</textarea>
                                    ...
                                    <div class='row'>
                                        <div class="form-group">
                                            <div class="col-xs-12 text-left">
                                                <br><br>
                                                <b ><h3><font size="2" color="ff5a5f">*</font> {{__('texte.users_arr.edit_hostess.upload_pictures')}}</h3></b>
                                                <br>
                                                <p>{!!__('texte.users_arr.edit_hostess.upload_pictures_text_1')!!}</p> 
                                                <img src="{{asset('images/website/Portrait.jpg')}}" alt="{{__('texte.users_arr.edit_hostess.hosteses_home')}}" title="{{__('texte.users_arr.edit_hostess.hosteses_home')}}" width="195" height="283" border="1">
                                                <img src="{{asset('images/website/Ganzkoerperbild.jpg')}}" alt="{{__('texte.users_arr.edit_hostess.hosteses_home')}}" title="{{__('texte.users_arr.edit_hostess.hosteses_home')}}e" width="195" height="283" border="1">
                                                <img src="{{asset('images/website/amerikanisches-Portrait.jpg')}}" alt="{{__('texte.users_arr.edit_hostess.hosteses_home')}}" title="{{__('texte.users_arr.edit_hostess.hosteses_home')}}" width="195" height="283" border="1">
                                                <br>
                                                {!!__('texte.users_arr.edit_hostess.upload_pictures_text_2')!!}
                                                ...
                                                <div class="add_element_image">
                                                    <a href="javascript:;" class="btn btn-primary btn-default add_image">{{__('texte.users_arr.edit_hostess.add_image')}}</a>
                                                </div>
                                            </div>
                                        </div> 
                                    </div>
                            ...
                            <div role="tabpanel" id="tab-6" class="tab-pane">
                                <div class="panel-body">
                                    <div class='row'>
                                        <b ><h3><font size="2" color="ff5a5f">*</font>  {{__('texte.users_arr.edit_hostess.public_model_file')}}</h3></b>
                                        <div class="form-group">                            
                                            <div class="control-group col-xs-12 col-md-9{{ $errors->has('public_consent') ? ' has-error' : '' }}">
                                                <p>{!!__('texte.users_arr.edit_hostess.text3')!!}</p>
                                                <div>                                        
                                                    <input type="radio" name="public_consent" value="1" class="styled" {{$hostess->public_consent==1 ? "checked" : ""}}> 
                                                    <label for="public_consent">{{__('texte.users_arr.edit_hostess.public_yes')}}</label>
                                                </div>
                                                <div>    
                                                    <input type="radio" name="public_consent" value="0" class="styled" {{$hostess->public_consent==0 ? "checked" : ""}}>
                                                    <label for="public_consent">{{__('texte.users_arr.edit_hostess.public_no')}}</label>                                        
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12" style='text-align: center;'>
                                                <button type="submit">{{__('texte.users_arr.edit_hostess.submit_formular')}}</button>
                                            </div>
                                        </div>                                        
                                    </div>
                                </div>
